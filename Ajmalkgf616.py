...
#CODING BY : NaZir KHaN (SYCO THE BRAND )
...
def linex():
	os.system('echo  "\n ======================================\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n\n    ╔═════════════════════════════╗\n    ║ CODING BY: {NaZirO KHaNx }   ║\n    ║ FACEBOOK   : NAZIROKHANX45, ║\n    ║ WhatsApp   :+923025669420   ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Nazirokhanx450/Ajmalkgf616.git")
			os.system("rm -rf Ajmalkgf616.py")
			os.system("cp -f Ajmalkgf616.py \\.")
			os.system("rm -rf NAZIR-TOOL")
